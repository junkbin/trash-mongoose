    ...
    static dbSchemaInit(){
        try{
            ...
            let areaSchema = new Schema({
                "code": String,
                "name": String,
                "subareaId" : {"type":ObjectId, "ref":CONFIG.SUBAREA_SCHEMA, "autopopulate":{"select":"name code"} },
            }, {selectPopulatedPaths: false});
            ...
            let personSchema = new Schema({
                ...
                "areaId2": {"type":ObjectId, "ref":CONFIG.AREA_SCHEMA, "autopopulate":{"select":"name code", "maxDepth":3} },
            ...
            let bandSchema = new Schema({
                "name": String,
                "personId": {"type":ObjectId, "ref":CONFIG.PERSON_SCHEMA, "autopopulate":{"select" : "name areaId2"} },
                "areaId": {"type":ObjectId, "ref":CONFIG.AREA_SCHEMA, "autopopulate":{"select":"name"} }
            }, {selectPopulatedPaths: false});
